...
public abstract class BaseXmlSyncState implements SyncState
{
	...
	/**
	 * Persist the sync state using the given {@link XmlContext}. This method is meant for debugging purposes, since {@link #store()} and
	 * {@link #store(XmlContext)} compress the data by default, making it harder to debug.
	 * 
	 * @param xmlContext
